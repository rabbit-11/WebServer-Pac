            ...
            $(function () {
                ...
                var web_list_callback = function (data) {
                    ...
                    if (data.result == webglobal.enum_const.service_result_success) {
                        ...
                        *否则显示编辑模式
                        */
                        if (hasfile && (initmod == webglobal.enum_mod.view || myextend.isNull(initmod))) {
                            require(["mod_pregnantinfo_summary"], function (summary) {
                                summary.show(globalwrapper);
                            });
                        }
                        else {
                            require(["mod_pregnantinfo_detail"], function (detail) {
