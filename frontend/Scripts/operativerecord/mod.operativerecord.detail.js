define(function () {
    ...
    function loaddata(data) {
        ...
        $.get(webglobal.templates.mod_operativerecord_detail, { stamp: Math.random() + 1 }, function (template) {
            var arr = [];
    ...
    function save(sender, success_callback, e) {
        ...
        var dataparam = myextend.HtmlEncode(JSON.stringify(data));
    ...
    function guiddata() {
        ...
        data.id=base.getDataID(globalwrapper);
